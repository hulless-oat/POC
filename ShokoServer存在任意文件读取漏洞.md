...
![image-20240911234300397](https://fhc-1328696168.cos.ap-beijing.myqcloud.com/image-20240911234300397.png)
...
def main():
    banner()
    parser = argparse.ArgumentParser(description='ShokoServer 存在任意文件读取漏洞')
