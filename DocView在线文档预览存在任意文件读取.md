...
![image-20240913090357472](https://fhc-1328696168.cos.ap-beijing.myqcloud.com/image-20240913090357472.png)
...
def main():
    banner()
    parser = argparse.ArgumentParser(description='DocView在线文档预览存在任意文件读取')
